...
from .views import Home,Signup,Login,Dashboard,CourseView,VerifyEmail,ForgotPasswordRequest,ResetPassword,Logout,About,ContactUs,ReturnPolicy,TermsAndCondition,PrivacyPolicy,Shipping,Payment,Payment_success,Payment_success_2nd,Payment_success_3rd,Withdraw
